...
#clearsites
#startsite "Island of Moreau" -- You can also use the site number
...
#clearsites
#startsite "The Forge of Souls" -- You can also use the site number

#likesterr 128

#clearrec
#addrecunit 6060
#addrecunit 6061 -- This will add the monster tag as a unit recruit from forts
#addrecunit 6062
#addrecunit 6063 -- Crusader Serf
...
#defcom1 34
#defunit1 6063 -- Crusader Serf
#defmult1 10 -- This many units will appear per 10 PD
#defcom2 34
#defunit2 6063 -- Crusader Serf
#defmult2 10 -- This many units will appear per 10 PD after 20

#wallcom 34
#wallunit 6063 -- Crusader Serf
#wallmult 10

#startcom 34
#startscout 426
#startunittype1 6063 -- Crusader Serf
...
#homecom 6055 -- Blood Summoner - This commander will be exclusively recruited from this site, and will show up on the recruitment overview on the ation screen
#homecom 6059 -- H3 Priest 	- This commander will be exclusively recruited from this site, and will show up on the recruitment overview on the ation screen
#homemon 6051 -- Gryphon Rider	- This monster will be exclusively recruited from this site, and will show up on the recruitment overview on the ation screen
#gems 1 4 -- 4 A gems
#gems 4 1 -- 1 S gem
#end
...
#clearsites
#startsite "The Spire" -- You can also use the site number

-- Units and Commanders
#clearrec
#addrecunit 6050
-- #addrecunit 6051 -- Cap-only 
#addrecunit 6052
#addrecunit 6053 

#addreccom 6054
-- #addreccom 6055 -- Cap-only
#addreccom 6056 
#addreccom 6057 
#addreccom 6058
-- #addreccom 6059 -- Cap-only

-- PD and Siege defenders
#defcom1 6054 -- This will lead your PD Troops 
#defunit1 6050 -- This is the unit that the PD calls for
#defmult1 14 -- This many units will appear per 10 PD
#defcom2 6054 -- This will also lead your PD after 20
#defunit2 6050 -- This unit will start appearing after 20 PD
#defmult2 21 -- This many units will appear per 10 PD after 20

#wallcom 6054 -- This commander will guard the walls when sieged
#wallunit 6050 -- This unit type will guard the walls when sieged
#wallmult 12 -- How many units there will be, no ifs or buts, no modifiers or anything. Just this many units.

#startcom 6054 -- Your starting troop leader you spawn in with
#startscout 426 -- Your starting Scout - vanilla scout
#startunittype1 6050  -- This unit will appear when you spawn in
...
#clearsites
#startsite "The Floating Complex" -- You can also use the site number instead
